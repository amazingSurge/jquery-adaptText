    ...
    var adaptText = function() {
      ...
      _createClass(adaptText, [{
        ...
        value: function _scrollOnHover() {
          ...
          this.$element.hover(
            ...
            function() {
              ...
              if (distance > 0) {
                var scrollSpeed = Math.sqrt(distance / that.width) * that.options.scrollSpeed;
        ...
        value: function resize() {
          ...
          this.$element.css('font-size', Math.floor(Math.max(Math.min(this.width / this.options.compression, parseFloat(this.options.max)), parseFloat(this.options.min))));
        }
      }, {
        key: 'enable',
        ...
        value: function resize(force) {
          if (!force && (0, _jquery2.default)(window).width() === viewportWidth) {
      ...
      return this.each(
        ...
        function() {
          if (!(0, _jquery2.default)(this).data(NAMESPACE)) {
            (0, _jquery2.default)(this).data(NAMESPACE, new adaptText(this, options));
          }
        }
      );
    };
